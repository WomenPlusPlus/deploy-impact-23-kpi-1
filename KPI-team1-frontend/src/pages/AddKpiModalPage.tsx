    ...
    <ModalRightSide isOpen={isOpen} onRequestClose={onRequestClose}>
      ...
      <div className="pt-10">
        ...
        <div className="text-sm my-3">
          You can check the additional informations to each selection if you are
          not sure which.
        </div>
        <div className="flex justify-center">
          <Box>
          ...
          <Box>
            <FormControl>
              <RadioGroup
                ...
                onChange={(e) => setCumulativeValue(e.target.value === "true")}
                row
      ...
      <div className="flex justify-center mt-10">
        ...
        <button
          className="w-24 h-10 bg-customYellow rounded justify-center items-center gap-2 inline-flex text-sm font-medium hover:bg-yellow-600"
